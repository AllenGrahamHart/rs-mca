...
The new tail9821.md envelope has height <=982, single-list agreement
>=55877, collision <=2946 and domain <=1058397. Its denominator
4201567 stays positive, giving <=13333 nonsingular pairs. The smaller-
dimensional weighted count and all 256 exceptions remain charged. The
generic maximal-model and double-fiber identities are not extrapolated
numerical inequalities; they are unchanged prerequisites. The kernel's
two verify_double_point_cubic_tail checks independently replay this scope.
