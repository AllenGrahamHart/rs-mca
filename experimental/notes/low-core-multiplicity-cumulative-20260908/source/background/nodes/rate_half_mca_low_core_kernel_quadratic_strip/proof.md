...
Current complete coverage through 9821 is proved in
`double_point_cubic_tail.md`, joined to `quartic_strip_payment.md`
and the independent earlier intervals. The actual <2A factor height,
256 exceptions and cumulative resource are retained. The statements below
are the original quadratic proof and historical intermediate links.
