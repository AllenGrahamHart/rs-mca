...
all-carrier interval theorems now pay:
    ...
    1038612..1043775         4801..9964            274979661975561635.

The remaining original interval is exactly1027077..1038611, equivalent
to J=9965..21499. Section18 proves the latest interval extension.
...
This section records the preceding700-degree stage. Section18 gives the
...
This is the previous300-degree stage; section18 owns the current complement.
...
contrapositive for EVERY complete original selection gives the then-current
...
## 18. Transport The Complete Raw-Mass Cubic Interval

For every complete original rank-twelve selection, sections2--3 give the
EXACT source of rate_half_mca_raw_mass_cubic_interval: original field,
finite labels, full-code-bad saturated supports, actual dimension11 and
empty universal core after cancelling ONLY the complete shared core.
Nonuniversal zero coordinates remain. Section4 permits maximal-raw
reselection inside that fixed carrier without retesting original rank or g.

The new supplier proves |Z|+134944<=274861473951141154 on EVERY
J9941..9964. The stronger basis count funds its entire high-defect range;
the full double-point kernel and factor classification cover every low
pair. No cubic-description premise or extra source-density gate remains.
Its256 off-gcd pair exceptions and one near allowance are already included.

Thus the entire original line is paid on1038612<=g<=1038635, exactly
24 complete core sizes. The new total is smaller than the existing lower
strip maximum, so4801..9964 keeps274979661975561635. The high union
21500..169999 and all other original-rank alternatives are unchanged.
The exact current residual isg1027077..1038611, equivalentlyJ9965..21499,
11535 integers. The main bound and its1066135833452 reserve do not move.

The2000/6000 fiber gates and clustered-arc overlap remain as in section17;
their lower endpoints exceed the new paid strip. The published low-raw
rank-filtration theorem retains its full9941..21499 scope, with its
necessary over-budget assertions now vacuous on the newly paid24 degrees.
It is NOT required by the new cubic supplier, avoiding a reverse dependency.
Taking the contrapositive for EVERY original complete selection gives the
new router restriction. No claim about original ranks>=13 or an unrestricted
MCA/LIST endpoint follows. Both Prize problems remain open.
