...
def verify_sources(manifest=None):
    ...
    require(manifest["schema"] == "low-core-complete-cubic-source-v1", "wrong schema")
    seen = set()
...
def main():
    ...
    print("CHECKS PASS; normalized 4801..8655 paid by hand proofs; unrestricted row OPEN")
