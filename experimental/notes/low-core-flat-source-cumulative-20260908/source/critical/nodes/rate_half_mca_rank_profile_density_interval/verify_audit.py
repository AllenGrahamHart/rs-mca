...
TOTAL = 273123695048315164
EXPECTED = "2dc6c17b530fa45a8f40864f9910ddb873492217f3785acf875a9946b2441e36"
...
def main():
    ...
    check(blocks==79 and count==30565 and mutations==61130,"entire independent inventory")
    check(digest.hexdigest() == EXPECTED,"all independent cost values")
    check(2130706433**6//2**128-TOTAL==1857033063079923,"original reserve")
    ...
    print("PASS every carrier on24000..26499; not an unrestricted row proof")
