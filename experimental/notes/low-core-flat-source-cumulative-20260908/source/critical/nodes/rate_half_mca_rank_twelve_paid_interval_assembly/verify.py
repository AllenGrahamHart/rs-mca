...
def verify(residual=(1008577, 1038635), total=274979661975561635):
    ...
    check((K-residual[1], K-residual[0]) == (9941, 39999), "unpaid child interval")
    check((K-1008576, K-878577) == (40000, 169999), "complete-core/high child transport")
    check((K-1043775, K-1038636) == (4801, 9940), "lower child transport")
    check(residual[1]-residual[0]+1 == 30059, "residual cardinality")
    check(35059-30059 == 44999-40000+1 == 5000, "new whole-source degree interval")
...
def main():
    verify()
    mutations = [((1008576, 1038635), 274979661975561635),
                 ((1008578, 1038635), 274979661975561635),
                 ((1008577, 1038634), 274979661975561635),
                 ((1008577, 1038636), 274979661975561635),
                 ((1008577, 1038635), 274979661975561634),
                 ((1008577, 1038635), 274979661975561636)]
    ...
    print("PASS: six boundary/budget mutations rejected; original rank-twelve residual J=9941..39999")
...
def verify_receiver_gates():
    def residual_fiber_gate(j, a):
        return 14000 <= j <= 39999 and a >= j-2000
    controls = ((14000, 12000, True), (14000, 11999, False),
                (13999, 13989, False), (25000, 24990, True),
                (10000, 9990, False), (39999, 37999, True),
                (39999, 37998, False), (40000, 38000, False),
    ...
    print("PASS: eleven residual fiber-gate controls; J>=40000 handled by the whole interval")
