...
- **Status:** harness + self-test **green** (13/13 PASS). The self-test
...
Verifier / self-test (no args) — runs the `(16,3)` recovery and the Task-1
window-audit arithmetic, PASS/FAIL per section, exit 0 iff all pass:
