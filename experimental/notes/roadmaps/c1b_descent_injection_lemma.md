...
- **Status:** the descent/injection/soundness chain (Lemmas D1-D4, Theorems
  ...
  verifier (19/19 PASS, ~10 s, <300 MB).  The **feasibility** of the
...
`midlarge_h_routes.md`.  Anchoring (`1 in R`, A3 sec 1.3) gives a
...
`midlarge_h_routes.md`).  Current replay: **19 PASS, 0 FAIL** (~10 s,
<300 MB peak).
