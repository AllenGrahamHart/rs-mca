...
prime_status (STAND-IN, loud), standin_prime, standin_prime_mod_1024,
...
The verifier re-runs every validation gate, re-verifies each claimed
collision/trade in exact `F_{p*}` arithmetic, and checks the certificate JSONs'
